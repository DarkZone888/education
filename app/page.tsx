...
export default function QuizApp() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-white to-pink-100 text-gray-900 p-4 flex items-center justify-center relative">
        ...
        {state.step === -1 && (
          ...
          >
            <img
              src="/images/home.png"
              alt="Start"
              className="mx-auto w-40 sm:w-48 md:w-56 lg:w-64 h-auto mb-3 object-contain"
            />
            <h1 className="text-xl sm:text-2xl font-semibold text-pink-800 mb-2">
              {t.startTitle}
            </h1>
          ...
          <AnimatePresence mode="wait">
            ...
            >
              <div className="bg-white rounded-lg shadow-md p-4 sm:p-6">
                ...
                <h2 className="text-lg sm:text-xl font-bold text-pink-900 mb-4">
        ...
        {state.step === quizData.length && (
          ...
          >
            <img
              ...
              className="mx-auto w-40 sm:w-48 md:w-56 lg:w-64 h-auto mb-3 object-contain"
            />
            <h2 className="text-xl sm:text-2xl font-semibold text-pink-800 mb-2">
