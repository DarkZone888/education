const results = {
  achiever: {
    ...
    description: {
      ...
      th: "คุณมีแรงจูงใจสูงและมีระเบียบแบบแผน มุ่งมั่นสู่ความเป็นเลิศในสิ่งที่ทำ ความทุ่มเทของคุณคือสิ่งที่โดดเด่น!"
    }
  },
  fighter: {
    icon: "⚔️",
    ...
    description: {
      ...
      th: "คุณต่อสู้ฝ่าฟันอุปสรรคด้วยความมุ่งมั่น แม้ในยามยากลำบาก คุณยังไม่ยอมแพ้!"
    }
  },
  slacker: {
    icon: "😴",
    ...
    description: {
      ...
      th: "คุณชอบความสบายและอิสระในการเรียนหรือทำงาน แต่บางครั้งแรงจูงใจอาจขาดหาย!"
    }
  },
  unknown: {
    icon: "❓",
    ...
    description: {
      ...
      th: "คำตอบของคุณยังไม่ชัดเจน ลองใหม่อีกครั้งเพื่อดูว่าคุณจะค้นพบตัวตนของตัวเองได้หรือไม่!"
    }
  }
};
